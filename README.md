...
33; its best checkpoint is epoch 31. The new experiment has functional coverage;
its quality and acceleration are not yet established. The gallery below remains
the measured **original diffuse pilot**, not results from the new architecture.
